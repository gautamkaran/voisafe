...
const StudentDashboard = () => {
  ...
  return (
    <div className="space-y-10 animate-fade-in-up">
      {/* Welcome Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-indigo-600 to-violet-700 p-6 sm:p-10 md:p-12 shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-indigo-100 text-base sm:text-lg max-w-xl font-medium leading-relaxed mb-8">
            Your voice is protected and your identity is decoupled. VoiSafe
            ensures your concerns reach the right people safely.
          </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {stats.map((stat) => (
          <div
            key={stat.name}
            className="glass-card rounded-4xl p-6 sm:p-8 flex items-center justify-between group hover:border-indigo-500/30 transition-all shadow-xl"
          >
            <div>
              <p className="text-slate-400 text-xs sm:text-sm font-bold uppercase tracking-widest mb-1">
                {stat.name}
              </p>
            ...
            <div
              className={`p-3 sm:p-4 ${stat.bg} rounded-2xl group-hover:scale-110 transition-transform`}
            >
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <Link
              ...
              className="text-indigo-400 text-sm font-bold hover:text-indigo-300 flex items-center gap-1 group"
            >
              View all{" "}
              <ArrowRight
                size={14}
          ...
          {loading ? (
            ...
            <div className="glass-card rounded-3xl p-8 sm:p-12 text-center border-dashed border-2 border-white/5">
              ...
              <p className="text-slate-500 max-w-xs mx-auto mb-8">
                You haven't submitted any grievances yet. Your identity will be
                100% protected when you do.
              </p>
              <Link
                to="/dashboard/submit"
            ...
            <div className="space-y-4">
              {complaints.slice(0, 3).map((c) => (
                ...
                >
                  <div className="glass-card rounded-2xl p-5 border border-white/5 group-hover:bg-white/2 transition-all flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div
                        className={`p-3 rounded-xl ${c.status === "resolved" ? "bg-emerald-500/10" : "bg-amber-500/10"}`}
                      >
                        <FileText
                          size={18}
                          className={
          ...
          <div className="glass-card rounded-[2.5rem] p-8 space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  Your account data is physically isolated from grievance
                  content.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  All communications use AES-256-GCM military-grade encryption.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div
                className={`flex-1 ${complaints.length > 0 ? "cursor-pointer group/chat" : ""}`}
              >
                <h5 className="font-bold text-white mb-1 group-hover/chat:text-amber-400 transition-colors">
                  Direct Authority Link
                </h5>
                <p className="text-sm text-slate-500 leading-relaxed mb-3">
                  Chat anonymously with resolution committees in real-time.
                </p>
                {complaints.length > 0 && (
