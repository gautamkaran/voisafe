    ...
    <div className="h-screen bg-slate-950 text-slate-100 flex overflow-hidden">
      ...
      >
        <div className="p-6 h-20 flex items-center justify-between">
          ...
          >
            <div className="p-2 bg-linear-to-br from-indigo-500 to-violet-600 rounded-xl shadow-lg">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
          {menuItems.map((item) => (
            ...
            >
              <item.icon
                className={`w-5 h-5 shrink-0 ${location.pathname === item.path ? "text-white" : "text-slate-400 group-hover:text-white"}`}
              />
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        {/* Background Decor */}
        <div className="absolute top-[-10%] left-[-10%] w-125 h-125 bg-indigo-600/5 rounded-full blur-[100px] pointer-events-none" />
          ...
          <div className="flex items-center gap-2 sm:gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <div className="flex items-center gap-3 pl-1 sm:pl-2">
                <div className="text-right hidden sm:block max-w-30">
                ...
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center font-bold text-white shadow-lg ring-2 ring-white/5 group-hover:ring-indigo-500/50 transition-all cursor-pointer">
                  {user.name.charAt(0)}
                </div>
              </div>
            </div>
